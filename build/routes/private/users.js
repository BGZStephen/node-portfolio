        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!userId) {
                        return [2 /*return*/, res.error({ message: 'No User ID provided', statusCode: 400 })];
                    }
...
function update(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, updatableFields, duplicateUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = req.user;
                    ...
                    if (req.body.newPassword && req.body.currentPassword) {
                        if (!user.passwordsMatch(req.body.currentPassword)) {
                            return [2 /*return*/, res.error({ message: 'Current password does not match stored password', statusCode: 400 })];
                        }
